...
Revision ID: a35350ef87d5
Revises: 
Create Date: 2026-07-19 16:49:54.878408
...
def upgrade() -> None:
    ...
    sa.Column('event_type', sa.Enum('TAB_SWITCH', 'MULTIPLE_FACES', 'NO_FACE_DETECTED', 'SCREEN_SHARE_DETECTED', 'UNUSUAL_EYE_MOVEMENT', 'WINDOW_BLUR', 'COPY_PASTE', name='interview_event_type'), nullable=False),
